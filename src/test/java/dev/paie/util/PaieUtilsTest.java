...
public class PaieUtilsTest {
	...
	@Test
	public void test_formaterBigDecimal_trois_chiffres_apres_la_virgule_up() {
		String resultat = paieUtils.formaterBigDecimal(new BigDecimal("2.001"));
		assertThat(resultat, equalTo("2.01"));
	}
